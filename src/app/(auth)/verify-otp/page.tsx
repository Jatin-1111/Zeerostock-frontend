      ...
      <div className="w-full max-w-xs bg-white border border-gray-200 rounded-lg p-4">
            ...
            <div className="flex justify-center gap-1" onPaste={handlePaste}>
              {otp.map((digit, index) => (
                <input
                  ...
                  disabled={loading}
                  className="w-6 h-7 text-center text-base font-bold border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400 text-gray-900 disabled:bg-gray-100 disabled:cursor-not-allowed"
                />
              ))}
            </div>
          </div>
        ...
        <div className="mt-3 space-y-2">
          ...
          <div className="text-center pt-2 border-t border-gray-200">
            <p className="text-xs text-gray-600 mb-1">Wrong email?</p>
            <Link
              href="/signup"
        ...
        <div className="mt-3 bg-blue-50 border border-blue-200 rounded-lg p-2">
          <div className="flex items-start gap-1.5">
            <svg
              className="w-2.5 h-2.5 text-blue-600 shrink-0 mt-0.25"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
