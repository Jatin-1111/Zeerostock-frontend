      ...
      <div className="w-full">
        ...
        <div className="flex gap-[16px]">
          ...
          >
            ...
            {/* Title */}
            <h3 className="mb-[4px] text-center text-[11px] font-medium leading-none text-[#0d1b2a]">
              Getting started Guide
            </h3>

            {/* Subtitle */}
            <p className="mb-[16px] text-center text-[9px] font-medium leading-none text-[#9c9c9c]">
              Complete setup guide
            </p>

            {/* Description */}
            <p className="mb-[16px] w-[170px] text-center text-[9px] font-medium leading-normal text-[#9c9c9c]">
            ...
            <motion.button
              ...
              className="h-[25px] w-[100px] rounded-[10px] bg-[#1e3a8a] px-[6px] py-[5px] text-[9px] font-medium leading-[11px] text-white transition-colors hover:bg-[#1e3a8a]/90"
            >
              Read Guide
            </motion.button>
          </motion.div>
