    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white border-b border-gray-200 py-12">
        <div className="mx-auto px-8">
          <h1 className="text-[40px] font-bold text-gray-900 mb-3 font-['Poppins']">
            Privacy Policy
          </h1>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="mx-auto px-8 py-6">
          <div className="bg-white border border-gray-300 rounded-lg p-4">
            ...
            <p className="text-[13px] text-gray-700 font-['Poppins']">
        ...
        <div className="flex gap-12">
          ...
          <div className="w-[300px] shrink-0">
            <div className="sticky top-8 border border-gray-300 rounded-lg p-4">
              <h3 className="text-[16px] font-semibold text-gray-900 mb-3 pb-3 border-b border-gray-300 font-['Poppins']">
                On This Page
              </h3>
              <nav className="space-y-1">
                {sections.map((section) => (
                  <button
                    ...
                    className="w-full text-left px-2 py-1.5 text-[13px] text-gray-700 hover:bg-gray-100 rounded transition-colors font-['Poppins']"
                  >
                    {section.label}
                  </button>
                ))}
          ...
          <div className="flex-1 space-y-8">
            ...
            <section id="introduction" className="space-y-6">
              <h2 className="text-[28px] font-bold text-gray-900 font-['Poppins']">
                Introduction
              </h2>
              ...
              <div className="space-y-4">
                <h3 className="text-[20px] font-bold text-gray-900 font-['Poppins']">
                ...
                <div className="space-y-3">
                  <div>
                    <h4 className="text-[16px] font-semibold text-gray-900 mb-1 font-['Poppins']">
                      Personal & Business Data
                    </h4>
                    <p className="text-[15px] text-gray-700 font-['Poppins']">
              ...
              <div className="bg-white border border-gray-300 rounded-lg p-6 space-y-3">
                <h4 className="text-[18px] font-bold text-gray-900 font-['Poppins']">
                  Contact Information
                </h4>
                <p className="text-[14px] text-gray-700 font-['Poppins']">
                  For any questions or requests regarding your data, please
                  contact us.
                </p>
                <div className="text-[14px] text-gray-700 font-['Poppins'] space-y-1">
                  <p>
            ...
            <div className="border border-gray-300 rounded-lg p-8 mt-12 bg-white">
              <h3 className="text-[24px] font-bold text-gray-900 mb-2 text-center font-['Poppins']">
                Have Questions About Your Privacy?
              </h3>
              <p className="text-[14px] text-gray-600 mb-6 text-center font-['Poppins']">
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <button className="px-6 py-3 border border-gray-900 text-gray-900 text-[15px] font-semibold rounded-lg hover:bg-gray-100 transition-colors font-['Poppins']">
                  View Guide
                </button>
              </div>
            </div>
