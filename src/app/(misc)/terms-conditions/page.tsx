        ...
        <div className="flex gap-12 mx-auto">
          ...
          <div className="flex-1 space-y-12">
            ...
            <section id="introduction">
              <h2 className="text-[28px] font-bold text-gray-900 mb-4 font-['Poppins']">
                1. Introduction
              </h2>
            ...
            <section id="marketplace">
              ...
              <p className="text-[15px] text-gray-700 leading-relaxed mb-3 font-['Poppins']">
              ...
              <ul className="space-y-2 text-[15px] text-gray-700 font-['Poppins']">
            ...
            <div className="border border-gray-300 rounded-lg p-6 mt-12 bg-white">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-[20px] font-bold text-gray-900 mb-1 font-['Poppins']">
                    Need Clarification?
                  </h3>
                ...
                <button className="px-6 py-3 bg-gray-900 text-white text-[15px] font-semibold rounded-lg hover:bg-gray-800 transition-colors font-['Poppins'] whitespace-nowrap ml-6">
          ...
          <div className="w-[300px] shrink-0">
            <div className="sticky top-8 border border-gray-300 rounded-lg p-6">
              <h3 className="text-[18px] font-semibold text-gray-900 mb-4 pb-3 border-b border-gray-300 font-['Poppins']">
                Page Contents
              </h3>
              <nav className="space-y-1">
                {sections.map((section) => (
                  <button
                    ...
                    className="w-full text-left px-3 py-2 text-[14px] text-gray-700 hover:bg-gray-100 rounded transition-colors font-['Poppins']"
                  >
                    {section.label}
                  </button>
                ))}
