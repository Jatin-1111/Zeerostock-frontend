          ...
          <div className="space-y-6">
            <div className="bg-white border border-gray-200 p-6">
              ...
              <p className="text-[12px] text-gray-600 leading-relaxed">
                Buyer claims: the shipment arrived with significant water damage
                to 30% of the order, Product condition documented, buyer
                requests partial refund & reshipment.
              </p>
            </div>
