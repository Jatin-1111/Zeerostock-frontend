      ...
      {stats && (
        <div className="grid grid-cols-4 gap-4 mb-6">
          <div className="bg-white border border-gray-200 p-4">
            ...
            <p className="text-[24px] font-bold text-black">{stats.pendingCount}</p>
          </div>
          <div className="bg-white border border-gray-200 p-4">
            <p className="text-[11px] text-gray-500 mb-1">UNDER REVIEW</p>
            <p className="text-[24px] font-bold text-blue-600">{stats.underReviewCount}</p>
          </div>
          <div className="bg-white border border-gray-200 p-4">
            <p className="text-[11px] text-gray-500 mb-1">VERIFIED</p>
            <p className="text-[24px] font-bold text-green-600">{stats.verifiedCount}</p>
          </div>
          <div className="bg-white border border-gray-200 p-4">
            <p className="text-[11px] text-gray-500 mb-1">REJECTED</p>
            <p className="text-[24px] font-bold text-red-600">{stats.rejectedCount}</p>
          </div>
        </div>
      )}
