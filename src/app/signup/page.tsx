      ...
      <div className="w-full max-w-md bg-white border-2 border-gray-200 rounded-lg p-8">
        ...
        <form className="space-y-4">
          ...
          <div>
            ...
            <select className="w-full px-3 py-2 border text-gray-800 border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-400">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 border text-gray-800 border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-400"
              />
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                type="text"
                placeholder="+91"
                className="w-16 px-3 py-2 border text-gray-800 border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-400"
              />
              <input
                type="tel"
