    ...
    <footer className="w-full bg-gray-100 border-t border-gray-200">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
          <div>
            <h3 className="font-bold text-gray-900 mb-4">Zeerostock</h3>
        ...
        <div className="pt-8 border-t border-gray-300">
          ...
          <div className="mt-6 text-xs text-gray-500 text-center">
            <p>
              ...
              marketplace. All referenced brand names and trademarks are the
              properties of their respective owners. The platform does not sell
              or buy products directly. For terms, conditions, and privacy
              policy, refer to our legal documents
            </p>
          </div>
        </div>
      </div>
