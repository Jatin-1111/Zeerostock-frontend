  ...
  return (
    <section className="relative w-full shadow-[0px_1px_4px_0px_rgba(24,181,34,0.25)] py-2 sm:py-3 md:py-[13px]">
      ...
      <div className="max-w-full sm:max-w-2xl md:max-w-3xl lg:max-w-[880px] mx-auto px-4">
        {/* Main Content */}
        <div className="relative z-10 flex flex-col items-center pt-6 sm:pt-8 md:pt-10 lg:pt-[44px] space-y-6">
          {/* Headline */}
          ...
          {/* Search Bar */}
          <div className="mt-4 sm:mt-6 md:mt-[29px] bg-[rgba(251,251,251,0.65)] rounded-2xl sm:rounded-3xl md:rounded-[33px] shadow-[0px_0px_27px_0px_rgba(0,0,0,0.25)] px-3 sm:px-4 md:px-[13px] py-2 sm:py-3 md:py-[5px] flex flex-row items-center gap-2 sm:gap-0 w-full max-w-[90%] sm:max-w-[80%] md:max-w-[70%] lg:max-w-[60%]">
            {/* Category Dropdown */}
          ...
          {/* CTA Buttons */}
          <div className="mt-4 sm:mt-6 md:mt-[30px] flex flex-col sm:flex-row gap-2 sm:gap-3 md:gap-[11px] w-full sm:w-auto">
            <button
          ...
          {/* Stats Bar */}
          <div className="mt-8 sm:mt-12 md:mt-16 lg:mt-[67px] text-center">
