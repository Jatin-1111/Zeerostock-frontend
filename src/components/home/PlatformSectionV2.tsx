...
export default function PlatformSectionV2() {
  return (
    <section className="bg-[#eefbf6] w-full py-3 sm:py-4 md:py-[19px]">
      <div className="max-w-full sm:max-w-2xl md:max-w-3xl lg:max-w-[880px] mx-auto px-4">
        ...
        <p className="text-center text-xs sm:text-sm md:text-[12px] font-semibold text-[#6b7280] mb-4 sm:mb-6 md:mb-[37px] leading-normal">
