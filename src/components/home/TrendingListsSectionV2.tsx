...
const imgProduct2 =
  "https://zeerostock-assets.s3.ap-south-1.amazonaws.com/Assets/196006c025d5e21c3d5e8aae0f4d45da.jpg";
const imgProduct3 =
  "https://zeerostock-assets.s3.ap-south-1.amazonaws.com/Assets/Industrial-Manufacturing-Services-Header-1200x900-Machine.jpg";
...
export default function TrendingListsSectionV2() {
  ...
  return (
    <section className="bg-[#eefbf6] w-full py-4 sm:py-5 md:py-[22px]">
      <div className="max-w-full sm:max-w-2xl md:max-w-3xl lg:max-w-[880px] mx-auto px-4">
        ...
        <p className="text-center text-xs sm:text-sm md:text-[13px] font-semibold text-[#6b7280] mb-6 sm:mb-10 md:mb-[57px] leading-normal">
          Discover high-demand inventory and stay informed with real-time market
          insights
        </p>

        {/* Content Grid - 75% scaled gap (39px → 29px) */}
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-5 md:gap-[19px] items-start">
