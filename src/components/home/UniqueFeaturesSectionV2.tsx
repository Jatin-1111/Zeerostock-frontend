...
export default function UniqueFeaturesSectionV2() {
  ...
  return (
    <section className="w-full py-4 sm:py-5 md:py-[23px] px-4 sm:px-6 md:px-8 lg:px-[40px]">
      ...
      <p className="text-center text-xs sm:text-sm md:text-[12px] font-semibold text-[#6b7280] mb-4 sm:mb-6 md:mb-[36px] leading-normal max-w-full sm:max-w-md md:max-w-[527px] mx-auto px-4 sm:px-0">
