    ...
    <section className="relative h-[500px] sm:h-[550px] md:h-[600px] bg-[#fefefe]">
      ...
      <div className="relative h-full max-w-[412px] sm:max-w-[640px] md:max-w-[768px] lg:max-w-[960px] mx-auto px-4 sm:px-6 md:px-8 flex flex-col items-center justify-center">
        ...
        <div className="text-center mb-6 sm:mb-7 md:mb-8 max-w-[380px] sm:max-w-[450px] md:max-w-[483px]">
          <h2 className="text-2xl sm:text-3xl md:text-3xl leading-snug sm:leading-snug font-medium text-[#0a2540]">
            Everything You Need To
          </h2>
          <h2 className="text-2xl sm:text-3xl md:text-3xl leading-snug sm:leading-snug font-medium text-[#2aae7a] mb-2 sm:mb-3">
            Succeed
          </h2>
          <p className="text-base sm:text-sm md:text-sm font-semibold text-[#868181]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 sm:gap-x-12 md:gap-x-16 gap-y-3 sm:gap-y-4 mb-6 sm:mb-7 md:mb-8 max-w-[380px] sm:max-w-[450px] md:max-w-[491px]">
          {features.map((feature, index) => (
            <div key={index} className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-xl sm:text-lg md:text-base leading-snug sm:leading-normal md:leading-tight text-[#0a2540] font-medium">
                {feature.title}
              </span>
            </div>
          ))}
        ...
        <Link
          href="/marketplace"
          className="w-[279px] sm:w-[220px] md:w-[200px] h-[35px] sm:h-[36px] md:h-[35px] bg-[#1e3a8a] text-white text-base font-medium rounded-[10px] hover:bg-[#1e3a8a]/90 transition-colors flex items-center justify-center"
        >
          Explore Features
        </Link>
      </div>
