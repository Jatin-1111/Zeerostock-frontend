    ...
    <section className="relative shadow-[0px_1px_4px_0px_rgba(24,181,34,0.25)]">
      ...
      <div className="relative h-[450px] sm:h-[500px] md:h-[550px] lg:h-[600px] w-full max-w-[412px] sm:max-w-[640px] md:max-w-[768px] lg:max-w-[960px] mx-auto px-4 sm:px-6 md:px-8 flex flex-col items-center justify-center">
        ...
        <h1 className="text-center mb-3 sm:mb-4 md:mb-5 max-w-[380px] sm:max-w-[445px] mt-[35px] sm:mt-[40px] md:mt-[45px]">
          <span className="text-3xl sm:text-4xl md:text-4xl leading-tight font-extrabold">
        ...
        {/* Subtitle */}
        <p className="text-center text-white text-sm sm:text-xs md:text-xs leading-normal sm:leading-normal md:leading-tight font-semibold max-w-[325px] sm:max-w-[380px] md:max-w-[415px] mb-6 sm:mb-7 md:mb-8">
          ...
          {isAuthenticated && user ? (
            ...
            <>
              <Link
                ...
                className="w-[140px] sm:w-[150px] md:w-[160px] h-[35px] sm:h-[38px] md:h-[40px] bg-[#022778] text-white text-xs sm:text-sm md:text-sm font-semibold rounded-lg hover:bg-[#022778]/90 transition-colors flex items-center justify-center"
              >
                Go to Dashboard
              </Link>
              <Link
                href="/marketplace"
                className="w-[140px] sm:w-[150px] md:w-[160px] h-[35px] sm:h-[38px] md:h-[40px] bg-white text-[#2aae7a] text-xs sm:text-sm md:text-sm font-semibold rounded-lg hover:bg-white/90 transition-colors flex items-center justify-center"
              >
                Browse Marketplace
              </Link>
            </>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[38px] sm:h-[42px] md:h-[45px] flex items-center justify-center">
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 md:gap-8 text-white text-sm font-bold px-2">
