...
export default function OrderHeader({
  ...
  return (
    <div className="text-center mb-12">
      ...
      {/* Title and Subtitle */}
      <div className="mb-6">
        <h1 className="font-['Poppins'] font-semibold text-[40px] leading-normal text-[#0d1b2a] mb-4">
          Order Confirmed!
        </h1>
        <p className="font-['Poppins'] font-medium text-[24px] leading-normal text-[#9c9c9c] max-w-[894px] mx-auto">
      ...
      <div className="flex items-center justify-center gap-12 flex-wrap mt-6">
        <div className="flex items-center gap-[9px]">
          <FileText
            ...
            strokeWidth={2}
          />
          <span className="font-['Poppins'] font-medium text-[22px] leading-normal text-[#9c9c9c]">
            Order #{orderNumber}
          </span>
        </div>
