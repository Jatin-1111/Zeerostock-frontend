  ...
  if (!items || items.length === 0) {
    return (
      <div className="bg-white rounded-[15px] p-[20px] mb-5 shadow-[0px_0px_5px_0px_rgba(0,0,0,0.25)]">
        <h2 className="font-medium text-[#0d1b2a] text-xl leading-normal mb-3">
          Order Items:
        </h2>
        <p className="font-medium text-[#9c9c9c] text-base">
          Loading order items...
        </p>
      </div>
    );
          ...
          >
            <div className="flex gap-[13px] h-full">
              ...
              <div className="flex-1 flex flex-col">
                {/* Product Name */}
                <h3 className="font-medium text-xl leading-normal text-black mb-[11px]">
                  {item.name || "Product"}
                </h3>

                {/* Seller */}
                <p className="font-medium text-base leading-normal text-[#9c9c9c] mb-[19px]">
                  by {item.seller || "Seller"}
                </p>

                {/* Quantity and Price */}
                <p className="font-medium text-base leading-normal text-[#9c9c9c]">
              ...
              <div className="flex flex-col items-end justify-start pt-[11px]">
                {/* Total Price */}
                <p className="font-semibold text-2xl leading-normal text-black mb-[13px]">
            ...
            {item.trackingId && (
              <div className="absolute bottom-0 left-0 right-0 h-[51px] flex items-center px-[15px] border-t border-gray-300">
                ...
                <span className="font-medium text-base leading-normal text-[#9c9c9c] ml-auto">
                  {item.trackingId}
                </span>
              </div>
            )}
