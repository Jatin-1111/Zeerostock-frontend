        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="border border-gray-300 rounded-lg p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-[18px] font-semibold text-gray-900 font-['Poppins']">
                Personal Information
              </h3>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-[13px] text-gray-700 mb-1 font-['Poppins']">
                  First name
                </label>
                <input
                  type="text"
          ...
          <div className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gray-900 text-white text-[15px] font-semibold rounded-lg hover:bg-gray-800 transition-colors font-['Poppins']"
            >
              Submit Application
            </button>
          </div>
