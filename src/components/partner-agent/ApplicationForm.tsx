      ...
      <div className="max-w-[1200px] mx-auto px-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="John"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-gray-900 text-black placeholder:text-black"
                />
              </div>
              <div>
                <label className="block text-sm text-gray-700 mb-1">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-gray-900 resize-none text-black placeholder:text-black"
                />
              </div>
          ...
          <div className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gray-900 text-white text-base font-semibold rounded-lg hover:bg-gray-800 transition-colors"
            >
              Submit Application
            </button>
          </div>
