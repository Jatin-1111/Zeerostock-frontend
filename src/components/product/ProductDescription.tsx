  ...
  return (
    <div className="bg-white rounded-[10px] shadow-[0px_0px_3px_0px_rgba(0,0,0,0.25)] overflow-hidden">
      ...
      <div className="relative border-b border-gray-200">
        <div className="flex px-5">
          ...
          <button
            ...
            className={`relative ml-[26px] px-0 py-2 text-sm font-medium transition-colors ${
      ...
      <div className="px-5 py-4">
        {activeTab === "description" && (
          <div>
            <h2 className="text-base font-medium text-[#0d1b2a] mb-3">
              Product description
            </h2>
            <p className="text-sm font-normal text-[#9c9c9c] leading-tight mb-6 wrap-break-words overflow-wrap-anywhere">
            ...
            <div className="grid grid-cols-2 gap-x-10 gap-y-6">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h4 className="text-sm font-medium text-[#0d1b2a] mb-0">
                    Fast Shipping
                  </h4>
                </div>
              </div>
        ...
        {activeTab === "specifications" && (
          <div>
            <h2 className="text-base font-medium text-[#0d1b2a] mb-4">
              ...
              <div>
                {productData.material_type && (
                  <div className="py-2 border-b border-gray-200">
                    <div className="text-xs font-normal text-[#9c9c9c] mb-1">
                      Material Type
                    </div>
