    ...
    <>
      ...
      >
        <div className="p-6 pb-8">
          ...
          {/* Agent Banner */}
          <div className="mb-6 p-4 border-2 w-64 border-gray-900 rounded-lg bg-white">
            <div className="flex items-start gap-3 mb-3">
              <svg
                className="w-6 h-6 text-gray-900 shrink-0 mt-1"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">
                  Become an Agent for Zeerostock!
                </h3>
                <p className="text-sm text-gray-600 mb-4">
                  Ready to grow your network and earn with Zeerostock? Start
                  your journey as a verified local agent today
                </p>
                <button className="w-full py-2 bg-gray-900 text-white rounded font-medium hover:bg-gray-800 transition-colors">
                  Apply Now!
                </button>
              </div>
            </div>
