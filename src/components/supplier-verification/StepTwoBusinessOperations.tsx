        ...
        <div className="px-3 py-4 space-y-4 flex-1 overflow-y-auto">
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full h-14 px-2.5 py-2 text-xs border border-border rounded focus:outline-none focus:ring-1 focus:ring-border text-black placeholder:text-muted resize-none"
            />
          </div>
